          ...
          <div className="h-full bg-[#F8F9FE] flex flex-col font-sans relative select-none">
            ...
            <div className="relative shrink-0 bg-gradient-to-br from-[#6C4CE0] to-[#5B3CD8] pt-12 pb-14 px-6 overflow-hidden shadow-sm">
              ...
              <div className="flex items-center justify-between relative z-20">
                ...
                <h1 className="text-white font-bold text-[22px] tracking-wide">My Profile</h1>
                <button className="p-2 text-white active:scale-95 transition-transform">
              ...
              <div className="flex flex-col items-center mt-6 relative z-20">
                <div className="relative">
                  <div className="w-24 h-24 rounded-full bg-white flex items-center justify-center p-1 shadow-xl relative overflow-hidden">
                    {isUploading && (
                  ...
                  <button 
                    ...
                    className="absolute bottom-0 right-0 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg border border-gray-50 active:scale-95 transition-transform"
                  >
                ...
                <h2 className="text-white text-[20px] font-bold mt-4 leading-tight">
                  {user.name}
                </h2>
                <div className="bg-white/20 px-4 py-1.5 rounded-full mt-2 shadow-sm border border-white/10">
                  <span className="text-white text-[11px] font-bold tracking-wide">{user.designation}</span>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-t-[25px] -mt-6 relative z-10 pt-8 px-5 pb-12 flex-1 w-full shadow-[0_-8px_20px_rgba(0,0,0,0.02)] overflow-y-auto hide-scroll">
              
              <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] py-5 px-4 grid grid-cols-3 mb-6 border border-gray-50">
                <div className="text-center flex flex-col items-center">
                  <div className="w-9 h-9 rounded-2xl bg-[#F0EDFF] flex items-center justify-center mb-2 shadow-sm">
                    <svg className="w-4 h-4 text-[#5B3CD8]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" /></svg>
                  </div>
                  <span className="text-[9px] text-gray-400 font-bold mb-1 uppercase tracking-wider">Emp ID</span>
                ...
                <div className="text-center flex flex-col items-center border-l border-r border-gray-100">
                  <div className="w-9 h-9 rounded-2xl bg-emerald-50 flex items-center justify-center mb-2 shadow-sm">
                    <svg className="w-4 h-4 text-emerald-500" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                  </div>
                  <span className="text-[9px] text-gray-400 font-bold mb-1 uppercase tracking-wider">Joined</span>
                  <p className="text-[12px] font-bold text-gray-900">{user.joinDate}</p>
                </div>

                <div className="text-center flex flex-col items-center">
                  <div className="w-9 h-9 rounded-2xl bg-sky-50 flex items-center justify-center mb-2 shadow-sm">
                    <svg className="w-4 h-4 text-sky-500" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  </div>
                  <span className="text-[9px] text-gray-400 font-bold mb-1 uppercase tracking-wider">Shift</span>
                  <p className="text-[12px] font-bold text-gray-900">{user.shift}</p>
                </div>
              </div>

              <div className="mb-6">
                <h3 className="text-[13px] font-bold text-gray-900 mb-3 px-1 tracking-wide">Contact Information</h3>
                <div className="bg-white rounded-[24px] border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 p-4 border-b border-gray-50">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5 truncate">{user.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 border-b border-gray-50">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5">{user.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5">{user.location}</p>
                    </div>
                  </div>
              ...
              <div className="mb-6">
                <h3 className="text-[13px] font-bold text-gray-900 mb-3 px-1 tracking-wide">Work Information</h3>
                <div className="bg-white rounded-[24px] border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 p-4 border-b border-gray-50">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5">{user.department}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 border-b border-gray-50">
                    ...
                    <div className="flex-1">
                      <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Designation</p>
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5">{user.designation}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 border-b border-gray-50">
                    ...
                    <div className="flex-1">
                      <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Reporting To</p>
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5">{user.manager}</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-4 p-4">
                    <div className="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center shrink-0">
                      <svg className="w-5 h-5 text-amber-500" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    </div>
                    <div className="flex-1">
                      <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Work Shift</p>
                      <p className="text-[14px] font-bold text-gray-900 mt-0.5">{user.shift}</p>
                    </div>
                  </div>
