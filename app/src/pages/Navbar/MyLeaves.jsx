              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center mt-20">
                  <div className="w-24 h-24 bg-indigo-50 rounded-full flex items-center justify-center mb-4">
                    <svg className="w-12 h-12 text-indigo-300" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                  </div>
                  <h2 className="text-[16px] font-bold text-gray-900 mb-1">No Leaves Found</h2>
                  <p className="text-[12px] text-gray-500 text-center px-4">You haven't applied for any leaves yet. Click the + icon above to apply.</p>
                </div>
              ) : (
